    ...
    <div class="dashboard-nav">
        <header>
            ...
            <nav class="dashboard-nav-list">
                ...
                <a href="/stud" class="dashboard-nav-item"><i class="fas fa-graduation-cap"></i>Список поступивших</a>
                <a href="/teacher" class="dashboard-nav-item"><i class="fas fa-chalkboard-teacher"></i>Преподовательский состав</a>
...
<style lang="scss">
  body {
      background-image: url("../src/assets/home.jpg"); /* Путь к фоновому изображению */
...
.dashboard-nav {
    background-color: rgba(65, 50, 32, 0.493);
    text-decoration: none
}
